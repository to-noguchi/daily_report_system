...
public class FollowService extends ServiceBase {
    ...
    /**
     * 社員番号、パスワードを条件に取得したデータをFollowViewのインスタンスで返却する
     * @param code 社員番号
     * @param plainPass パスワード文字列
     * @param pepper pepper文字列
     * @return 取得データのインスタンス 取得できない場合null
     */
    public FollowView findOne(String code, String plainPass, String pepper) {
        Follow f = null;
        try {
            //パスワードのハッシュ化
            ...
            f = em.createNamedQuery(JpaConst.Q_FOL_GET_BY_CODE_AND_PASS_DEF, Follow.class)
    ...
    public long countByCode(String code) {
        ...
        long follows_count = (long) em.createNamedQuery(JpaConst.Q_FOL_COUNT_REGISTERED_BY_CODE, Long.class)
                .setParameter(JpaConst.JPQL_PARM_CODE, code)
                .getSingleResult();
